...
\begin{document}
    ...
    \begin{abstract}
        ...
        \textit{Web 3.0} immer mehr an Bedeutung gewinnt, bedarf es einer neuen Technologie, die durch die Ideen des
        \textit{Web 3.0} die Probleme des Finanzsystems zu lösen versucht.
    ...
    \section{Einführung}
    \input{sections/paper/einfuehrung}

    \section{Bekannte Finanzsysteme}
    \input{sections/paper/finanzsysteme}

    \section{Kryptowährungen}
    \label{sec:krypto}
    \input{sections/paper/kryptowaehrungen}

    \section{Wallets und Transaktionen}
    \input{sections/paper/wallets_tx}



    \section{Fazit}
    \input{sections/paper/fazit.tex}
